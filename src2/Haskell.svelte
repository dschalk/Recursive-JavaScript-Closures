...
<p> If you are learning to program in Haskell, there's a good chance that the book or blog or  videos on which you rely is telling you that mutations, side effects, and unpredictable functions can can only as values in monads, usually the IO monads. If so, you are being deceived.  </p>
