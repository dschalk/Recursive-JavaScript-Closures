...
<br>
<button on:click = {factors}>factors()</button>
<br><br>
...
<br>
<p> There are many ways to display the behavior of monads returned by Monad(). For this demonstration, a simple object named "O" was created and Monad was modified to make the name of each monad an attribute pointing to the monad's internal array. Here's the revised definition of Monad.</p>
